...
- `src/`
  - `components/`: Componentes para cada atividade do desafio.
  - `App.js`: Página principal que serve como menu para acessar as atividades.
...
## Comentários no Código
 - O código está comentado para explicar o funcionamento de cada componente, especialmente onde usamos `useState` e `useEffect`. Comentários detalham a lógica dos temporizadores e outros recursos.
